...
function Categories() {
    ...
    async function toDeleteCategory(id) {
        let isDelete = window.confirm("Ви впевневні, що хочете видалили цю категорію?");
        if(isDelete) {
    ...
    return(
        <mainDiv>
            ...
            <button style = {{width: "25%"}} type="button" class="button" onClick={() => {window.location.href="/addCategory"}}>
                <span class="button__text">Додати категорію</span>
                   ...
                   <div class="search-result-item-body">
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <p class="info">Опис: {description}</p>
                        </div>
                        <button onClick = {() => toDeleteCategory(_id)}   type="button" class="btn btn-danger">Видалити</button>
                        <button onClick={() => {window.location.href="updateCategory/"+_id}}  type="button" class="btn btn-warning">Змінити</button>
                    </div>
                </div>
                </section>
                </div>
